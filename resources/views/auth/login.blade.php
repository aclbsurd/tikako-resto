        ...
        <div class="col-lg-10">
            ...
            <div class="card border-0 shadow-lg overflow-hidden rounded-4" style="min-height: 500px;">
                <div class="row g-0 h-100">
                    ...
                    {{-- BAGIAN KIRI: GAMBAR SUASANA --}}
                    {{-- Teknik: position-relative di kolom, position-absolute di gambar --}}
                    <div class="col-lg-6 d-none d-lg-block position-relative bg-dark">
                        ...
                        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center text-white p-5 text-center" style="background: rgba(0,0,0,0.4); z-index: 2;">
                            <h2 class="fw-bold mb-3 display-6" style="font-family: 'Charm', cursive;">Selamat Datang Kembali!</h2>
                            <p class="lead fs-6">Nikmati kemudahan memesan makanan favoritmu tanpa antre.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-center bg-white">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <div class="text-center mb-5">
                                ...
                                <p class="text-muted small">Silakan login untuk melanjutkan pesanan Anda.</p>
                            </div>

                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                
                                {{-- Input Email (Gaya Standar Bersih) --}}
                                <div class="mb-4">
                                ...
                                {{-- Input Password (Gaya Standar Bersih) --}}
                                <div class="mb-4">
